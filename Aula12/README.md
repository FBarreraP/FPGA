...
entity pulsador_lector is
	port (
		clk: in std_logic; 
		btn: in std_logic; 
		led: out std_logic  
	);
end entity pulsador_lector;

architecture behavioral of pulsador_lector is
...
ENTITY DigitalRead_tb IS
END DigitalRead_tb;

ARCHITECTURE DigitalRead_tb_arch OF DigitalRead_tb IS
-- constants                                                 
-- signals                                                   
